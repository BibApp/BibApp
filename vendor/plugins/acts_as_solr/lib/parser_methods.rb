module ActsAsSolr #:nodoc:
  ...
  module ParserMethods
    ...
    def parse_query(query=nil, options={}, models=nil)
      valid_options = [:offset, :limit, :facets, :models, :results_format, :order, :scores, :operator, :handler, :filter_queries]
      query_options = {}
      ...
      begin
        ...
        if options[:order]
          query_options[:order] = replace_types([order], false)[0]
        end

        #filters should be unique.
        query_options[:filter_queries].flatten!.uniq!
