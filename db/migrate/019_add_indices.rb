class AddIndices < ActiveRecord::Migration
  ...
  def self.down
    ...
    remove_index :authors, :name => :fk_person_id
    ...
    remove_index :citations, :name => :fk_publication_id
    remove_index :citations, :name => :fk_publisher_id
    ...
    remove_index :publications, :name => :fk_publisher_id
    remove_index :publications, :name => :fk_authority_id
    ...
    remove_index :publishers, :name => :fk_authority_id
