...
ActiveRecord::Schema.define(:version => 20080910214815) do
  ...
  add_index "contributorships", ["person_id", "work_id"], :name => "work_person_join"
  ...
  add_index "keywordings", ["keyword_id", "work_id"], :name => "work_keyword_join", :unique => true
  ...
  add_index "work_name_strings", ["name_string_id", "work_id"], :name => "work_name_string_join", :unique => true
