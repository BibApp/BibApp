...
ActiveRecord::Schema.define(:version => 20080730143005) do
  ...
  create_table "citation_name_strings", :force => true do |t|
    ...
    t.integer  "citation_id",    :limit => 11
  ...
  add_index "citation_name_strings", ["citation_id", "name_string_id"], :name => "citation_name_string_join"
  ...
  create_table "citations", :force => true do |t|
    ...
    t.integer  "citation_state_id",         :limit => 11
    t.integer  "citation_archive_state_id", :limit => 11
