...
describe "OpenUrlConferenceContext" do
  it "should return a valid ConferencePoster type_uri" do
      FactoryGirl.build(:conference_poster).type_uri.should ==  "http://purl.org/eprint/type/ConferencePoster"
  end

  it "should generate a valid openurl context" do
    #attrs = FactoryGirl.attributes_for(:conference_paper)

    FactoryGirl.build_stubbed(:conference_poster) do |poster|
      ns = [FactoryGirl.build_stubbed(:name_string)]
